...
const S4Tokenomics = () => {
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-5 px-4 sm:px-6 lg:px-8 py-24  relative ">
      ...
      <div className="flex flex-col mt-40 mb-20 pt-40 pb-20 relative  align-middle justify-center text-center  
     " id="token">
