...
const S4Tokenomics = () => {
  ...
  <div className="flex flex-wrap justify-center md:justify-around gap-8 sm:gap-8 mt-6 w-full">
    <img
      src={Str1}
...
>
         ...
         <div className="w-full relative gap-10 flex flex-col  ">
          <div className=' flex flex-col justify-center items-center text-center w-full'>
            ...
            <h2 className=" bg-text-custom-gradient     bg-clip-text text-transparent font-semibold w-[50%] text-2xl   sm:w-[70%] sm:text-3xl  md:w-[100%] md:text-4xl  md:w-[100%] lg:text-5xl     ">
              The Financial Framework of CUBIPAY
            </h2>
                 </div>
           
          </div>
          <div className='hidden sm:block  absolute top-[-7rem]    left-1/2 w-[100%] -z-10 transform -translate-x-1/2'>
...
<div className="flex justify-center align-middle px-10 mt-8">
  ...
  />
              ...
              <div className=' hidden sm:block absolute transform -translate-x-1/2 rotate-180 top-auto bottom-[-7rem]    left-1/2 w-full -z-10 '>
<img src={img1} alt="" className='absolute max-h-none left-1/2 transform -translate-x-1/2 -translate-y-[55%] top-0' />
{/* <img src={img2} alt="" className='absolute max-h-none left-0 w-full' /> */}

</div>

        <div className="  flex flex-1 font-quantico font-bold flex-wrap justify-center  gap-2 sm:gap-4  mt-8 md:pt-0  " id='one'>
          <div className=" flex flex-col sm:flex-row   justify-center sm:w-[33%] w-full  phone:w-56    tablet:flex-1            " id='two'>
            <Button leftText="TOKEN NAME" rightText="CUBIPAY" />
          </div>
          <div className="w-[33%]  phone:w-56    tablet:flex-1 flex flex-col sm:w-[33%] w-full  justify-center   items-center align-middle        ">
