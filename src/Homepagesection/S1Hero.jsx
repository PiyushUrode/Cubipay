...
const S1Hero = () => {
  ...
  return (
    <> 
    <div className=" min-h-[120vh] relative  header-background   ">
      <div
        id="Hero"
        className="relative min-h-[110vh]  w-full h-full flex flex-col md:flex-row items-center px-5 md:px-10 py-10"
      >
            ...
            >
              ...
              >
                ...
                <div className="flex flex-row gap-10 justify-center md:justify-start">
                  ...
                  <button
  onClick={openPDF}
  className="relative px-20 py-5 text-white rounded-full bg-custom-gradient border-2 border-transparent"
>
